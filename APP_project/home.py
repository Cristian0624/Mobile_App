...
class ReminderScreen(BaseScreen):
    ...
    def __init__(self, **kwargs):
        ...
        circle_btn.set_colors(bg_color=(1, 1, 1, 1), fg_color=(0, 0, 0, 1))  # White background, black text
        ...
        self.add_text = Label(
            ...
            font_size=dp(14),
            bold=True,
            color=(0, 0, 0, 1),  # Black text to match plus button
            size_hint=(1, None),
            height=dp(25)
        )
    ...
    def save_reminder(self, instance):
        ...
        if not medication_name:
            # Show error (could be improved with a proper notification)
    ...
    def update_theme(self, *args):
        ...
        if hasattr(self, 'frequency_button'):
            # Keep the yellow color for better UX, just adjust brightness
            if is_dark:
                self.frequency_button.bg_color = (0.6, 0.55, 0.2, 1)  # Darker yellow for dark mode
            else:
                self.frequency_button.bg_color = (0xfd/255, 0xde/255, 0x86/255, 1)  # Original yellow
...
class VoiceScreen(BaseScreen):
    def __init__(self, **kwargs):
        ...
        self.send_btn = RoundedButton(
            ...
            size_hint=(0.2, None),
            height=dp(50),
            bg_color=self.theme_manager.get_accent_color()
        )
...
class LoginScreen(Screen):
    def __init__(self, **kwargs):
        ...
        self.show_password_btn = Button(
            ...
            size_hint=(0.15, 1),
            background_normal='',
            background_color=(0.8, 0.8, 0.8, 0.8)  # Semi-transparent gray
        )
        ...
        self.login_btn = RoundedButton(
            ...
            bg_color=(0.2, 0.6, 0.9, 0.9)  # Semi-transparent blue
        )
        ...
        self.register_btn = RoundedButton(
            ...
            height=dp(50),
            pos_hint={'center_x': 0.5, 'center_y': 0.3},
            bg_color=(0.3, 0.8, 0.3, 0.9)  # Semi-transparent green
        )
        ...
        self.main_layout.add_widget(password_layout)
        self.main_layout.add_widget(self.login_btn)
        self.main_layout.add_widget(self.register_btn)
...
class SignupScreen(Screen):
    def __init__(self, **kwargs):
        ...
        self.back_btn = RoundedButton(
            ...
            height=dp(50),
            pos_hint={'center_x': 0.5, 'center_y': 0.3},
            bg_color=(0.8, 0.8, 0.8, 0.9)  # Semi-transparent gray
        )
        self.back_btn.bind(on_release=self.show_login)
        
        # Add widgets directly to main layout
        self.main_layout.add_widget(self.username_input)
        self.main_layout.add_widget(password_layout)
        self.main_layout.add_widget(self.confirm_password_input)
        self.main_layout.add_widget(self.register_btn)
